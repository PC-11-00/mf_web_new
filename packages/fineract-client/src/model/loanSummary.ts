...
export interface LoanSummary { 
    ...
    totalFeeChargesDueAtDisbursement?: number;
    totalFeeChargesOutstanding?: number;
    totalFeeChargesRepaid?: number;
    totalFeeChargesWaived?: number;
    totalFeeChargesWrittenOff?: number;
    totalInterestCharged?: number;
    totalInterestOutstanding?: number;
    totalInterestRepaid?: number;
    totalInterestWaived?: number;
    totalInterestWrittenOff?: number;
    totalOutstanding?: number;
    totalPenaltyChargesCharged?: number;
    totalPenaltyChargesOutstanding?: number;
    totalPenaltyChargesRepaid?: number;
    totalPenaltyChargesWaived?: number;
    totalPenaltyChargesWrittenOff?: number;
    totalPrincipalAdjustments?: number;
    totalPrincipalDisbursed?: number;
    totalPrincipalOutstanding?: number;
    totalPrincipalRepaid?: number;
    totalPrincipalWrittenOff?: number;
